      ...
      <div className="container">
        <div className="container-text">
          ...
          <div className="content-compromisso">
            ...
            <div className="paragraph">
              ...
              <Paragraph size="md">
                ...
                elaborou a presente Política de Privacidade com a finalidade de
                demonstrar o seu compromisso e respeito para com as regras de
                privacidade e de proteção de dados pessoais.
              </Paragraph>
              <Paragraph size="md">
                Esta Política de Privacidade aplica-se exclusivamente à recolha
                e tratamento de dados pessoais efetuados pela Bilgi.
              </Paragraph>
              <Paragraph size="md">
          ...
          <div className="content-tratamento">
            <div className="subtitle">
              <Subtitle size="lg">
                Responsável pelo tratamento de dados e o encarregado da proteção
                de dados
              </Subtitle>
            </div>
            <div className="subtitle">
            ...
            <div className="paragraph">
              <Paragraph size="md">
                A Bilgi tem, também, um Encarregado da Proteção de Dados (DPO),
                que desempenha um papel relevante no tratamento de dados
                pessoais, garantindo, entre outros aspectos, (i) a conformidade
                dos tratamentos de dados com a legislação em vigor, (ii)
                procedendo à verificação do cumprimento desta Política de
                Privacidade de Dados e definindo regras claras de tratamento de
                dados pessoais, (iii) assegurando que todos os que lhe confiam o
                tratamento dos seus dados pessoais, tenha, conhecimento de forma
                como a Bilgi trata os mesmos e quais os direitos que lhes
                assistem nesta matéria.
              </Paragraph>
            </div>
          </div>
          ...
          <div className="content-dados">
            ...
            <div className="paragraph">
              <Paragraph size="md">
                Entende-se por dados pessoais qualquer informação relativa a uma
                pessoa singular identificada ou identificável (“titular dos
                dados”); é considerada identificável uma pessoa singular que
                possa ser identificada, direta ou indiretamente, em especial por
            ...
            <div className="paragraph">
              <Paragraph size="md">
                ...
                dizem respeito e que usufrui dos serviços ou produtos da Bilgi.
              </Paragraph>
              <Paragraph size="md">
            ...
            <div className="paragraph">
              <Paragraph size="md">
                A Bilgi recolhe os dados pessoais nas seguintes circunstâncias:
              </Paragraph>
              <Paragraph size="md">
              ...
              <Paragraph size="md">
                Alguns dados pessoais são indispensáveis à execução do contrato
                e, em caso de falta ou insuficiência dos mesmos, a Bilgi não
                poderá disponibilizar o serviço em causa.
              </Paragraph>
              <Paragraph size="md">
                Os dados pessoais recolhidos podem ser tratados informaticamente
                e de forma automatizada ou não automatizada, garantindo em todos
                os casos o estrito cumprimento da legislação de proteção de
                dados pessoais em vigor, sendo armazenados em bases de dados
                específicas, criadas para o efeito e, em situação alguma, os
                dados recolhidos serão utilizados para outra finalidade que não
                seja aquela para a qual foram recolhidos ou dado o consentimento
            ...
            <div className="paragraph">
              <Paragraph size="md">
                Quando o tratamento for necessário ao cumprimento de obrigações
                legais, como por exemplo, a resposta a entidades judiciais, de
                regulação e de supervisão, entre outros.
              </Paragraph>
            </div>
            <div className="subtitle">
            ...
            <div className="paragraph">
              <Paragraph size="md">
                É garantido, aos Clientes e aos Utilizadores, enquanto titulares
                dos dados pessoais, em qualquer momento, o direito de acesso,
                retificação, atualização, limitação e apagamento dos dados
                pessoais (salvo caso os mesmos sejam indispensáveis à prestação
              ...
              <Paragraph size="md">
                ...
                Clientes /Utilizadores, de novos produtos ou serviços através de
                telefone, e-mail, SMS, MMS ou qualquer outro serviço de
              ...
              <Paragraph size="md">
                O titular de dados pessoais pode exercer os seus direitos junto
                do Responsável pelo tratamento, através dos contatos
            ...
            <div className="paragraph">
              <Paragraph size="md">
                O website ou aplicação da Bilgi poderá encontrar links de acesso
                a websites de terceiros. A Bilgi não se responsabiliza pela
                recolha e tratamento de dados pessoais efetuados nesses websites
                de terceiros.
              </Paragraph>
              <Paragraph size="md">
                A recolha ou tratamento dos dados pessoais solicitados por esses
                terceiros é da sua exclusiva responsabilidade, não podendo a
                Bilgi ser responsabilizada, em qualquer circunstância, pelo
                conteúdo desses websites ou pela má utilização dos dados
                recolhidos ou tratados por intermédio dos mesmos.
              </Paragraph>
              <Paragraph size="md">
                Assim, a disponibilização de links para websites de terceiros
                não implica qualquer assunção de responsabilidade relativamente
                a tais websites, não lhes sendo, por conseguinte, aplicável a
                presente Política de Privacidade.
              </Paragraph>
              <Paragraph size="md">
                A Bilgi alerta para a necessidade de os Clientes e Utilizadores,
                antes de visitarem websites de terceiros procederem à leitura
                das Políticas de Privacidade definidas por esses terceiros.
              </Paragraph>
            </div>
            ...
            <div className="medidas">
              ...
              <div className="paragraph">
                <Paragraph size="md">
                  A Bilgi tem implementado medidas técnicas, organizativas e de
                  segurança adequadas, necessárias e suficientes para proteger
                  os seus dados pessoais contra a destruição, o extravio, a
                  alteração e o acesso não autorizados ou qualquer outra forma
